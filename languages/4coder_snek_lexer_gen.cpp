/*
4coder_snek_lexer_gen.cpp - Model definition for a Sneklang lexer.
*/

// TOP

#define LANG_NAME_LOWER snek
#define LANG_NAME_CAMEL Snek

#define GENERATED_BY "custom/4coder_scewps/languages/4coder_snek_lexer_gen.cpp"
