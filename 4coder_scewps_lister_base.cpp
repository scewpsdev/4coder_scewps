...
lister_render(Application_Links *app, Frame_Info frame_info, View_ID view){
    ...
    Rect_f32 region = view_get_screen_rect(app, view);
    {
        ...
        u64 lister_margin_x = def_get_config_u64(app, vars_save_string_lit("lister_margin_x"));
        u64 lister_margin_y = def_get_config_u64(app, vars_save_string_lit("lister_margin_y"));

        region.x0 += lister_margin_x;
        region.y0 += lister_margin_y;
    ...
    f32 block_height = lister_get_block_height(app, line_height);
