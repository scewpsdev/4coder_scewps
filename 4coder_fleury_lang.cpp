...
#define F4_RegisterLanguage(name, language_name, IndexFile, LexInit, LexFullInput, PosContext, Highlight, lex_state_type) _F4_RegisterLanguage(name, language_name, IndexFile, (F4_Language_LexInit *)LexInit, (F4_Language_LexFullInput *)LexFullInput, (F4_Language_PosContext *)PosContext, (F4_Language_Highlight *)Highlight, sizeof(lex_state_type))

internal void
_F4_RegisterLanguage(String_Const_u8 name,
                     String_Const_u8 language_name,
                     ...
                     u64 lex_state_size)
{
    ...
    if(language == 0)
    {
        ...
        language->language_name = push_string_copy(&f4_langs.arena, language_name);
